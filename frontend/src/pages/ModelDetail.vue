      ...
      <div class="detail-header">
        ...
        <div>
          ...
          <div class="detail-meta">
            <span class="detail-provider">{{ PROVIDER_LABELS[model.provider] || model.provider }}</span>
...
.detail-title { font-size: 22px; font-weight: 700; margin: 0 0 6px; color: var(--text); }
...
.copy-btn--abs { position: absolute; top: 10px; right: 10px; z-index: 1; }
